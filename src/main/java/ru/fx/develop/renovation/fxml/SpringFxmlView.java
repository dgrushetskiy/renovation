package ru.fx.develop.renovation.fxml;
...
import ru.fx.develop.renovation.util.Lang;
...
public class SpringFxmlView implements ApplicationContextAware, Observer {
...
//		}
    ...
    public Parent getView() {
        ...
        bundle = getBundle(BUNDLES_FOLDER);
    ...
    public Parent getView(Locale locale) {
        ...
        bundle = getBundle(BUNDLES_FOLDER, locale);
